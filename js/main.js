...
const HINT_DFLT_MSG = 'This field is required';
;// CONCATENATED MODULE: ./src/js/formValidate.js
...
function FormValidate() {
  ...
  inputColl.forEach(item => {
    ...
    input.oninput = ({
      target
    }) => inputValidate(target.type, target.value, field, submitBtn);
  });
